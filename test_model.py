...
def generate_insights(summary, df):
    ...
    prompt = f"""
You are a senior data analyst. Based on the dataset below, generate insights.
...
Instructions:
1. Identify any trends or patterns (e.g., older people invest more).
2. Mention differences between groups (e.g., males vs females).
3. Include interesting correlations.
4. Write 4–5 insight sentences in plain business language.
    """
